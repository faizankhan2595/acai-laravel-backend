                ...
                <div class="card-box">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xs-12 col-md-10 col-md-offset-1">
                            <div class="p-20">
                                <form action="{{ route('page.store') }}" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                    @csrf
                                    <div class="form-group">
                                        <label for="title">Page Title<span class="text-danger">*</span></label>
                                        <input type="text" name="title" placeholder="Enter title" class="form-control" id="title" parsley-trigger="change" required value="{{ old('title') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="name">Page Content</label>
                                        <textarea name="content" class="editor" required>{{ old('content') }}</textarea>
                                    </div>
