                ...
                <div class="card-box">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xs-12 col-md-10 col-md-offset-1">
                            <div class="p-20">
                                <form action="{{ route('faq.store') }}" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="question" placeholder="Enter Question" class="form-control" id="question" parsley-trigger="change" required value="{{ old('question') }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="answer">Answer<span class="text-danger">*</span></label>
                                        <textarea name="answer" placeholder="Answer" class="form-control" id="answer" parsley-trigger="change" required>{{ old('answer') }}</textarea>
                                    </div>
