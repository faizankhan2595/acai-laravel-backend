                ...
                <div class="card-box">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xs-12 col-md-10 col-md-offset-1">
                            <div class="p-20">
                                <form action="{{ route('merchant.store') }}" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <input type="checkbox" id="is_project_acai" name="is_project_acai" data-switch="primary"/>
                                        <label for="is_project_acai" data-on-label="Yes" data-off-label="No"></label>
                                    </div>
                                    <div class="form-group">
                                        <label for="sort_order">Sorting Order</label>
                                        <input type="number" name="sort_order" placeholder="Sorting Order" class="form-control" id="sort_order" value="{{ old('sort_order') }}">
                                    </div>
                                    <div class="form-group">
