                ...
                <div class="card-box">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xs-12 col-md-10 col-md-offset-1">
                            <div class="p-20">
                                <form action="{{ route('salesperson.store') }}" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="dob" placeholder="mm/dd/yyyy" id="dob" value="{{ old('dob') }}" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" placeholder="Enter Password" class="form-control" id="password" parsley-trigger="change" required value="{{ old('password') }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="password_confirmation">Confirm Password<span class="text-danger">*</span></label>
                                        <input type="password" name="password_confirmation" placeholder="Enter Password" class="form-control" id="password_confirmation" parsley-trigger="change" required value="{{ old('password_confirmation') }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="account_status" class="form-control" id="link">
                                            ...
                                            <option value="0" {{ (!is_null(old('account_status')) && old('account_status') == 0) ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                    </div>
