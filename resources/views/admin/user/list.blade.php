...
@section('content')
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <div class="pull-right">
                            <a href="{{ route('user.exportexcel') }}" class="btn btn-primary"><i class=" mdi mdi-share"></i> Export Users</a>
                            ...
                            <button data-target="#importModal" data-toggle="modal" class="btn btn-warning"><i class=" mdi mdi-import"></i> Import Excel</button>
                        </div>
    ...
    <div id="importModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="importModal" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content p-0 b-0">
                <div class="panel panel-color panel-primary">
                    <div class="panel-heading">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h3 class="panel-title" id="modal_head">Import From Excel</h3>
                    </div>
                    <form id="import_form" action="{{ route('user.importexcel') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="file" id="excel_file" name="excel_file" class="filestyle" data-buttonname="btn-primary">
                                        <small class="text-danger">Upload .xlsx file</small>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="checkbox-inline"><input type="checkbox" name="sent_email" value="1">Send Welcome Email</label>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
